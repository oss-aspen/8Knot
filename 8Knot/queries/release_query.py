...
def release_frequency_query(self, repos):
    ...
    query_string = f"""
                    SELECT
                        r.repo_id as id, 
                        e.repo_added as created, 
                        r.release_published_at
                    FROM
                        augur_data.releases as r, augur_data.repo as e
                    WHERE
                        r.repo_id = e.repo_id and 
                        r.release_published_at is not null and
