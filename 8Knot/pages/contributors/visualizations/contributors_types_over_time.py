...
def create_contrib_over_time_graph(repolist: List[int], contribs, interval, bot_switch: bool) -> Tuple[go.Figure, bool]:
...
def create_figure(df_drive_repeat, interval) -> go.Figure:
