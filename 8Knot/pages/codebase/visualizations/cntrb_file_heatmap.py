...
def cntrb_file_heatmap_graph(repo_id, directory, bot_switch):
    ...
    for query_func, query_name in [(rfq, "repo_files"), (cnq, "contributors"), (cpfq, "cntrb_per_file")]:
...
def process_data(
    ...
    try:
        ...
        # Clean contributor data - drop unnecessary columns
        ...
        # Step 3: Map contributors to last activity using new utility
        # First get last activity per contributor
